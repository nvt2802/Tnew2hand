                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-4 pt-5">
                            <h2 className="h2 text-success border-bottom pb-3 border-light logo">Tnew 2hand</h2>
                            <ul className="list-unstyled text-light footer-link-list">
                                ...
                                <li>
                                    ...
                                    <a className="text-decoration-none"
                                       href="mailto:info@company.com">Tnew@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-md-4 pt-5">
                            ...
                            <ul className="list-unstyled text-light footer-link-list">
                                <li><a className="text-decoration-none" href="#">Vintage</a></li>
                                <li><a className="text-decoration-none" href="#">Work Shirt</a></li>
                        ...
                        <div className="row pt-2">
                            <div className="col-12">
                                <p className="text-left text-light">
                                    Copyright &copy; 2023 Tnew 2hand
                                    | Designed by <a rel="sponsored" href="https://templatemo.com"
                                                     target="_blank">Tan Tan</a>
                                </p>
                            </div>
                        </div>
                    </div>
